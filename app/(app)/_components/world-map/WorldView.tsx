...
export default function WorldView({ goalTree, characterPosition, onSelectContinent, onSelectCountry }: WorldViewProps) {
  return (
    <div className="rounded-2xl border border-purple-500/25 bg-slate-950/40 p-3">
      ...
      <WorldMapCanvas goalTree={goalTree} characterPosition={characterPosition} continentId={null} onSelectContinent={onSelectContinent} onSelectCountry={onSelectCountry} />
    </div>
  );
}
