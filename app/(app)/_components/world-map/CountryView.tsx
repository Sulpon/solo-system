...
type CountryViewProps = Readonly<{
  countryId: string;
  goalTree: GoalTree;
...
export default function CountryView({ countryId, goalTree, selectedGoalId, onBack, onLinkGoal, onUnlinkGoal, onSelectActiveGoal }: CountryViewProps) {
  ...
  return (
    <div className="rounded-2xl border border-purple-500/25 bg-[radial-gradient(circle_at_50%_10%,rgba(88,28,135,0.16),transparent_55%),linear-gradient(180deg,rgba(2,6,23,0.96),rgba(8,6,20,0.98))] p-5">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-slate-800 bg-slate-950/50 p-4">
          ...
          <p className="mt-2 text-sm text-slate-500">0 / 0 — coming soon</p>
        </div>
        {boss ? (
