...
const RIVAL_SEEDS: ReadonlyArray<RivalSeed> = [
  ...
  { id: "alex-morgan", name: "Alex Morgan", title: "The Strategist", icon: "♟️", originContinentId: "north-america", originCountryId: "usa", primary: "trading", secondaries: ["discipline", "career"], strength: "Strategy", weakness: "Adaptability", archetype: "consistent", personality: { activityRate: 0.88, consistency: 0.93, explorationRate: 0.45, aggression: 0.35, challengePreference: 0.75, specialization: 0.92, recoveryRate: 0.85 } },
  ...
  { id: "thabo-nkosi", name: "Thabo Nkosi", title: "The Warrior", icon: "🛡️", originContinentId: "africa", originCountryId: "south-africa", primary: "physical-health", secondaries: ["discipline", "career"], strength: "Strength", weakness: "Patience", archetype: "unpredictable", personality: { activityRate: 0.5, consistency: 0.4, explorationRate: 0.5, aggression: 0.55, challengePreference: 0.5, specialization: 0.5, recoveryRate: 0.5 } },
  ...
  { id: "ji-woo-han", name: "Ji-woo Han", title: "The Consistent", icon: "📅", originContinentId: "asia", originCountryId: "south-korea", primary: "discipline", secondaries: ["career", "self-development"], strength: "Consistency", weakness: "Aggression", archetype: "consistent", personality: { activityRate: 0.7, consistency: 0.88, explorationRate: 0.4, aggression: 0.3, challengePreference: 0.6, specialization: 0.75, recoveryRate: 0.8 } },
